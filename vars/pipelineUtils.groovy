def buildApp() {
    stage('Build with Maven') {
        echo 'Building the Java application (from shared library)...'
...
def dockerBuildAndPush() {
    stage('Docker Build & Push') {
        echo 'Building and pushing Docker image (from shared library)...'
...
def deployApp() {
    stage('Deploy') {
        echo 'Deploying the container (from shared library)...'
        sh """
